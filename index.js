...
(function () {
  ...
  function animateViewTransition(
    ...
    function step() {
      ...
      var t = Math.min(1, (currentTime - startTime) / duration);
      var easedT = easeInOutQuart(t);

      viewer.view().setYaw(startYaw + (endYaw - startYaw) * easedT);
      viewer.view().setPitch(startPitch + (endPitch - startPitch) * easedT);
      viewer.view().setFov(startFov + (endFov - startFov) * easedT);
